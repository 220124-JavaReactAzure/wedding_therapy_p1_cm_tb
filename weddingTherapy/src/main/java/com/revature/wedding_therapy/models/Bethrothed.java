...
public class Bethrothed {
	...
	public Bethrothed(int wedding_id, String wedding_roll, String first_name, String last_name) {
		super();
	...
	public String toString() {
		return "Bethrothed [wedding_id=" + wedding_id + ", wedding_roll="
	...
	@Override
	public int hashCode() {
		return Objects.hash(first_name, last_name, wedding_id, wedding_roll);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(first_name, other.first_name) && Objects.equals(last_name, other.last_name)
				&& wedding_id == other.wedding_id && Objects.equals(wedding_roll, other.wedding_roll);
	}
